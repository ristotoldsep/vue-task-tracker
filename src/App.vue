...
import AddTask from './components/AddTask' */ //ADDED THESE TO views/Home.vue
...
export default {
  ...
  components: {
    Header,
    /* Tasks,
    AddTask, */ //Added these to views/Home.vue
    Footer
  },
  data() {
    return {
      // tasks: [], //Added to views/Home.vue
      showAddTask: false,
    }
  },
  methods: {
    ...
    //   //ADDED vue.config.js => api = localost....
    //   const res = await fetch('api/tasks')
